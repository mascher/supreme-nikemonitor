...
if(__name__ == "__main__"):
    ...
    webhook = "https://discordapp.com/api/webhooks/481077216558710785/NeHLa1u4y2OInRd1-KL8PkiJ0Gnkhnaz0Vvdo1kVUxdoTToK5BAeUOWEvyvvfx-HnzDY"  # Put your webhook link here

    delay = 15  # Lots of sites + few proxies = longer delay to avoid bans
